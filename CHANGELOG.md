...
## [0.19.0](https://github.com/pepe57/rag-kit/compare/v0.18.3...v0.19.0) (2026-03-02)
...
* /new session reset + structured checkpoint summaries ([#172](https://github.com/pepe57/rag-kit/issues/172)) ([6366d78](https://github.com/pepe57/rag-kit/commit/6366d785440fcb4f80ef5f577525d96e53d37410))
* add --debug flag and strengthen Albert sample count requirement ([a2a85d3](https://github.com/pepe57/rag-kit/commit/a2a85d30d292765e1522bfffc2cb1086b316ceb8))
* add --debug flag to show agent tool calls ([54a9a4a](https://github.com/pepe57/rag-kit/commit/54a9a4a4cb1e70b76a9bf60bbab86fcdfae5ba05))
* add --expert flag to setup command and rename PDF pipeline to Local ([4c8b584](https://github.com/pepe57/rag-kit/commit/4c8b584bf156cadd212277d104bc41699699186a))
* add --expert flag to setup command and rename PDF pipeline to Local ([3605a5a](https://github.com/pepe57/rag-kit/commit/3605a5a12555b1e961994c3243b0b7559f55a8da))
* add --version flag to rag-facile CLI ([daadefe](https://github.com/pepe57/rag-kit/commit/daadefe020b6f06c0dd9f166540d82ee16a3c5c3))
* add .envrc support to standalone workspaces ([57e6ed3](https://github.com/pepe57/rag-kit/commit/57e6ed369dba02fb09139c41cf8b806b33c50f21))
* add `rag-facile uninstall` and `rag-facile upgrade` commands ([6dcb688](https://github.com/pepe57/rag-kit/commit/6dcb688d10f35264948e9946b0f7e3103af2b6f0))
* add `rag-facile uninstall` and `rag-facile upgrade` commands ([5c39988](https://github.com/pepe57/rag-kit/commit/5c3998898d247f809d229e924692875bfc6eb2e1))
* add Albert API provider for eval generate command ([467f8be](https://github.com/pepe57/rag-kit/commit/467f8be563b68cb3bd22f32f1ba75aa4b52407a7))
* Add Albert Client SDK - Complete Python SDK for Albert API ([ebf3d55](https://github.com/pepe57/rag-kit/commit/ebf3d55fa603cf1f9fcfed0024dae6f646080d0f))
* add albert-client package template for monorepo workspaces ([1e99698](https://github.com/pepe57/rag-kit/commit/1e9969868d0c3228cef8d04b76cd2e1c3975048f))
* add albert-client SDK Phase 1 (core client + OpenAI passthrough) ([0424d2c](https://github.com/pepe57/rag-kit/commit/0424d2c1b8adf9f0eb6bcb9d3a2fcc35f28da5a1))
* add CI smoke test — scaffold, build and launch Chainlit app ([b70fd49](https://github.com/pepe57/rag-kit/commit/b70fd498d96121f611e3c259183fc69315820b83))
* add CI smoke test — scaffold, build and launch Chainlit app ([2ffa86f](https://github.com/pepe57/rag-kit/commit/2ffa86f63d723911083eb04c4bdd104a14e23c82))
* add comprehensive logging for provider interactions and debugging ([a6d5f14](https://github.com/pepe57/rag-kit/commit/a6d5f146194cafd70eb151403c1642cbea8bfa2d))
* add config management CLI commands ([4b87b59](https://github.com/pepe57/rag-kit/commit/4b87b59c9468a8dfbbf28affee546a51f08b440b))
* add debug output for provider IDs during eval generate ([52e48d7](https://github.com/pepe57/rag-kit/commit/52e48d7ae4a509a9332ed1c39430bad236443eaf))
* add direnv support for automatic .env loading ([6e1ca21](https://github.com/pepe57/rag-kit/commit/6e1ca2117807a631963f171dbc23491a127d1588))
* add document preprocessing with PDF extraction for eval providers ([e97504b](https://github.com/pepe57/rag-kit/commit/e97504b0af3a12a9dbfc6f71802738fb0b50583f))
* add DSFR theme for Chainlit chat app ([a9d4570](https://github.com/pepe57/rag-kit/commit/a9d4570a9bc51caf1b23c33bf7666b9cd3e114c5))
* add DSFR theme for Reflex chat app ([d523204](https://github.com/pepe57/rag-kit/commit/d523204d16a639b7a8a54f1fcb680b561b6b0a7d))
* add DSFR-style theme toggle dropdown to Reflex navbar ([b402a67](https://github.com/pepe57/rag-kit/commit/b402a6763ee95bd790b2189ced88be0552fc69aa))
* add get_docs tool with bundled documentation ([b315d6f](https://github.com/pepe57/rag-kit/commit/b315d6fca7b9262267235c6d8bd609c31ef40a6c))
* add ingestion package with pluggable provider interface ([648b8a5](https://github.com/pepe57/rag-kit/commit/648b8a5f9b3cde1b4b7e2b293ec07383a9ba3f04))
* add ingestion package with pluggable provider interface ([f4323ac](https://github.com/pepe57/rag-kit/commit/f4323ac354619b87802b0e497556da8a692a688f))
* Add initial `ragfacile.toml` configuration file for RAG system settings. ([482ad12](https://github.com/pepe57/rag-kit/commit/482ad12a58ecacf99c4bd9afa09989504fdc5d4e))
* add interactive collection badges to chat apps ([fadd438](https://github.com/pepe57/rag-kit/commit/fadd4385bc532dd1093e7b2131d69adb151ca377))
* add just sync task to install dependencies and pre-commit hooks ([2e5dd71](https://github.com/pepe57/rag-kit/commit/2e5dd71ef385bc7ad87d4b665c27db2c69b2d5bb))
* add OPENAI_API_KEY fallback for AlbertClient initialization ([418b5f2](https://github.com/pepe57/rag-kit/commit/418b5f233d3432ea8d331ec0a3c9158d589fe5f9))
* add orchestration package and simplify retrieval ([0a212fa](https://github.com/pepe57/rag-kit/commit/0a212fa3fb45d70109cccda6bb3111339ceb185b))
* add orchestration package and simplify retrieval ([b470702](https://github.com/pepe57/rag-kit/commit/b470702d905a923f2991a53f25b48e0305c415fb))
* add pipeline tracing with SQLite backend ([563a206](https://github.com/pepe57/rag-kit/commit/563a2064a98e975e81a6d3d2e5e8dbecd15a65b3))
* add pipeline tracing with SQLite backend ([6701619](https://github.com/pepe57/rag-kit/commit/67016199ede798a6c5b94f7dc37a2c6b48fc0e01))
* add proxy support to install script for corporate/restricted networks ([0a90cc3](https://github.com/pepe57/rag-kit/commit/0a90cc305b1747183b0dac12aa8f169008f54626))
* add public collections as RAG sources ([7c0fee8](https://github.com/pepe57/rag-kit/commit/7c0fee833db7039db55dadf4bb7a242f7501e8af))
* add query expansion system (multi-query + HyDE) ([ef5418e](https://github.com/pepe57/rag-kit/commit/ef5418ef7d8ad3ac00bd3d5a591ec56815b6e7d7))
* add query expansion system with multi-query and HyDE strategies ([7c44a3f](https://github.com/pepe57/rag-kit/commit/7c44a3f6149cd311280c4dc307d1e6145a65ff56))
* add rag-config package with complete RAG pipeline configuration ([2a48da4](https://github.com/pepe57/rag-kit/commit/2a48da40c281d0aa57ddc9e2edd091cae490b63c))
* add random seed to LLM calls for diversity ([53de37b](https://github.com/pepe57/rag-kit/commit/53de37bbe016686e6f95e4baeb59cf5912850092))
* add retrieval-albert package and remove Chroma placeholder ([32a93af](https://github.com/pepe57/rag-kit/commit/32a93af64a53dd3a02ce3bb01bb55927fb47e5f8))
* add retrieval-albert package and remove Chroma placeholder ([7834dce](https://github.com/pepe57/rag-kit/commit/7834dce74b6738dd08370ba4b713baa2ac4088c6))
* add support for public Albert collections as RAG sources ([6d9ec12](https://github.com/pepe57/rag-kit/commit/6d9ec12b07b6a8429190c15f02609074e81dabc4))
* add support for public Albert collections as RAG sources ([4fc5903](https://github.com/pepe57/rag-kit/commit/4fc5903088262b3046319e692fb5323cfbf550ac))
* add Windows support with proto as unified dependency manager ([5c0ee40](https://github.com/pepe57/rag-kit/commit/5c0ee403200d52ad1909d0c2e50fc565ea2ab56f))
* add Windows support with proto as unified dependency manager ([6cd5300](https://github.com/pepe57/rag-kit/commit/6cd5300f3fee0362314f9e1c9b555e3279c90f04))
* add workflow to sync templates on release PRs ([8a3e381](https://github.com/pepe57/rag-kit/commit/8a3e381ca836a94a4936d50ed608b72062a5697e))
* **albert-client:** log API errors with gh issue command for 5xx ([3721c65](https://github.com/pepe57/rag-kit/commit/3721c656d8a4237a4a609e4b615eef1c928ccfba))
* **albert-client:** log API errors with gh issue command for 5xx ([cff3299](https://github.com/pepe57/rag-kit/commit/cff3299909b73317dd2b2b5aee404316acc61122))
* **albert-client:** update to v0.4.0 API spec ([246fc11](https://github.com/pepe57/rag-kit/commit/246fc11ce3b171a9bcba741dce3fe94a52f15e56))
* **albert-client:** update to v0.4.0 API spec ([46b348b](https://github.com/pepe57/rag-kit/commit/46b348b1098fe4fe2097c0742edf9c60921fccf0))
* apply reranking consistently in dataset generation and evaluation ([d50a319](https://github.com/pepe57/rag-kit/commit/d50a319c328366246c7419b22e202b698e160fe1))
* auto initial commit after rag-facile setup ([4d83f3e](https://github.com/pepe57/rag-kit/commit/4d83f3ef6c74083119a40aaee05aa85152a78150))
* automate template synchronization on release ([2960013](https://github.com/pepe57/rag-kit/commit/2960013a0ac4eab9f2beceecb7ac38085b69eb17))
* bundle pipeline packages under rag_facile namespace for library distribution ([2271dc7](https://github.com/pepe57/rag-kit/commit/2271dc7daac78e07fc125a5d2053fca1b8ba9ef8))
* bundle pipeline packages under rag_facile namespace for library distribution ([0867970](https://github.com/pepe57/rag-kit/commit/0867970e6b352cf1cafb9a6c6eb83129c2917569))
* capture chunk IDs in dataset generation and evaluation ([1b60175](https://github.com/pepe57/rag-kit/commit/1b60175a35ef99410d67c11c3bb58b8a6160b5c3))
* capture relevant_chunk_ids and relevant_contexts for ground truth ([bdd5911](https://github.com/pepe57/rag-kit/commit/bdd5911801aea57408c1237b35adba75ff3ab9aa))
* chat workspace init — first-run wizard ([465094c](https://github.com/pepe57/rag-kit/commit/465094c2be08792b23da414b644535ccf732e99e))
* chat workspace init — first-run wizard ([051301c](https://github.com/pepe57/rag-kit/commit/051301c999bb5a8ada2332ef816c5c32ead8be27))
* codebase awareness tools (get_agents_md, get_recent_git_activity) ([4f845e6](https://github.com/pepe57/rag-kit/commit/4f845e6200beb330ab04d2d5302989c1cc8507da))
* codebase awareness tools (get_agents_md, get_recent_git_activity) ([771ab25](https://github.com/pepe57/rag-kit/commit/771ab25de3cdbbb96ff38ee07e002a0740bb0d8e))
* component-first architecture refactoring ([e289d15](https://github.com/pepe57/rag-kit/commit/e289d157ac2d45c2b82d47be1fdef775874c6281))
* component-first architecture refactoring with auth fixes ([23425ff](https://github.com/pepe57/rag-kit/commit/23425ffd7745c3cd06c03d5e508cb5bed04da618))
* comprehensive eval generate improvements (PDF extraction, logging, debug flag) ([a6e431a](https://github.com/pepe57/rag-kit/commit/a6e431a75e7eeb722740c44442894a554c56a25c))
* display config show in RAG pipeline order with descriptions ([c810ccb](https://github.com/pepe57/rag-kit/commit/c810ccb3ce77b9d1527a79acd2e6310bf70f3539))
* display config show in RAG pipeline order with descriptions ([5955e82](https://github.com/pepe57/rag-kit/commit/5955e8298f87c625789d339ca3d246e8ed793784))
* DSFR theme for Chainlit chat app ([6eef5cf](https://github.com/pepe57/rag-kit/commit/6eef5cf3559c055e738279a7fe1e0570b7806c4a))
* DSFR theme for Reflex chat app ([16b1c06](https://github.com/pepe57/rag-kit/commit/16b1c0614c6daf06b6b37a4357825071f7fedc88))
* end-to-end evaluation with live RAG pipeline ([bd6b426](https://github.com/pepe57/rag-kit/commit/bd6b42686aab568d048c6843f1345d2dcbd4a69d))
* **eval:** add Data Foundry synthetic Q/A generation ([6371225](https://github.com/pepe57/rag-kit/commit/63712250a8ea6883aff5caddeea0979e66b0e2cc))
* extract text content from `Hub-France-IA-Les-risques-de-lIA-Generative.pdf` into a new `.txt` file. ([0f190ff](https://github.com/pepe57/rag-kit/commit/0f190ff2dda7259dbc09e3e765a910f10cc2174a))
* flat-file memory package with standard file-operation tools ([1af6a04](https://github.com/pepe57/rag-kit/commit/1af6a04769a4e0d6470dc0ca6f55e348d8624d59))
* git-backed session memory with post-session summarisation ([18502bc](https://github.com/pepe57/rag-kit/commit/18502bc879489c052ef29975fda8cead6701c4ef))
* git-backed session memory with post-session summarisation ([46e3928](https://github.com/pepe57/rag-kit/commit/46e3928432a02fe65b805353d32654dc3bb9f3eb))
* implement Phase 2 (Search + Rerank) for Albert Client SDK ([675ad56](https://github.com/pepe57/rag-kit/commit/675ad56815574b385edd42042f379d84740ec592))
* implement Phase 3 (Collections & Documents) for Albert Client SDK ([f7d29af](https://github.com/pepe57/rag-kit/commit/f7d29af15ae09bc1b5be3402331d382641a0b41a))
* implement Phase 4 (Tools & Monitoring) for Albert Client SDK ([4b0abba](https://github.com/pepe57/rag-kit/commit/4b0abba2fe3cd0e0d6433f3915f31bd38ebe36d3))
* initialize git repo and add .gitignore on workspace setup ([3ff2fb0](https://github.com/pepe57/rag-kit/commit/3ff2fb09fdeb5cd9f246882a33d3b21b5d5fb18b))
* initialize git repo and add .gitignore on workspace setup ([3a7fb7d](https://github.com/pepe57/rag-kit/commit/3a7fb7d23ab725e0ac65fb8f4520a7115d894a67))
* integrate config presets into workspace setup command ([657dc02](https://github.com/pepe57/rag-kit/commit/657dc028e3401612a0fa6d3baee2e05c605b1b08))
* integrate config system into apps (Phase 4) ([4b6c2dc](https://github.com/pepe57/rag-kit/commit/4b6c2dcc9f817d9eb59bd06efba4ebb1895c5b0b))
* integrate rag-config package into workspace generation ([dc58587](https://github.com/pepe57/rag-kit/commit/dc58587195cf90c784f07f66b815b364fa865a8e))
* integrate rag-config system into workspace generation + module renaming ([7e44788](https://github.com/pepe57/rag-kit/commit/7e44788c42bbbc66ae50d6464c36ef37a9c0b572))
* local PDF fallback when Albert parse API fails ([67350f2](https://github.com/pepe57/rag-kit/commit/67350f2eeb9490a8f656273ab2dd847be9654e0a))
* memory compaction — 3-layer pruning for unbounded token growth ([#173](https://github.com/pepe57/rag-kit/issues/173)) ([a0bb6e3](https://github.com/pepe57/rag-kit/commit/a0bb6e3cf8a61bf40c9a0d639e74d834fa9baa72))
* memory consolidation wiring + LLM fact extraction ([#174](https://github.com/pepe57/rag-kit/issues/174)) ([101fe9d](https://github.com/pepe57/rag-kit/commit/101fe9d19cd7d8bbc6ffbf1c48c639cbcf9de23d))
* move frontend choice behind --expert flag ([88bb4b9](https://github.com/pepe57/rag-kit/commit/88bb4b9ad0d94a1de4a718554df7f14f90b720b4))
* move frontend choice behind --expert flag in setup command ([5ed23bb](https://github.com/pepe57/rag-kit/commit/5ed23bbe9b215400c5f1c450becaf9b61da57d8b))
* multi-format file support for retrieval-albert, update TEST_PLAN ([7ab2bc3](https://github.com/pepe57/rag-kit/commit/7ab2bc32a950273c4684f87dea2077ce17252f62))
* new install flow — curl+uv+just, pre-built workspace zip ([9ab8c7a](https://github.com/pepe57/rag-kit/commit/9ab8c7a0ae0e5f4643c09b6a54cb358ab7d6d461))
* new memory package with flat-file tools and simplified directory layout ([2b8900d](https://github.com/pepe57/rag-kit/commit/2b8900dcc29b0a0c021170d344c7d98f26b44844))
* RAG configuration management system ([2a5974d](https://github.com/pepe57/rag-kit/commit/2a5974db8f4b69f7596652e3109818d968070fbe))
* RAG Configuration System - Phases 4 & 5 (App Integration + Setup Integration) ([f5fce7a](https://github.com/pepe57/rag-kit/commit/f5fce7a997f1cdeb923c1fd62155c767a53255c3))
* RAG evaluation with Inspect AI — recall@k, precision@k, faithfulness ([6151adf](https://github.com/pepe57/rag-kit/commit/6151adf1566152f682e6ef3b022df96d10d90480))
* RAG evaluation with Inspect AI — recall@k, precision@k, faithfulness ([9820954](https://github.com/pepe57/rag-kit/commit/982095424e51c5e0493c70537ab2275191fc0d60))
* rag-facile chat — smolagents harness spike ([e912a0e](https://github.com/pepe57/rag-kit/commit/e912a0e7bd40e56064a89763dc6073fc9c30713c))
* rag-facile chat — smolagents harness spike ([4764f55](https://github.com/pepe57/rag-kit/commit/4764f55892749871f0a89dbeaf77a00e0ce63817))
* rationalise CLI UX — grouped help panels, simpler setup, smarter just run ([f846b93](https://github.com/pepe57/rag-kit/commit/f846b933d4bf182b3f70adbd8b925f09ea9e2959))
* rationalise CLI UX — grouped help panels, simpler setup, smarter just run ([03a0f7f](https://github.com/pepe57/rag-kit/commit/03a0f7f548a99947cf163b9f286baea039668ed4))
* semantic skill routing via activate_skill tool — drop keyword detection ([aaac2e9](https://github.com/pepe57/rag-kit/commit/aaac2e995865e1ff762083672fe3441abe076398))
* skills system with 5 built-in skills + npx skills integration ([aefe01a](https://github.com/pepe57/rag-kit/commit/aefe01a22870685d11d7048fcf00a2ed55574d15))
* skills system with 5 built-in skills + npx skills integration ([72b1f3d](https://github.com/pepe57/rag-kit/commit/72b1f3d61fc322cfce56bcf98b600f5a986b4dbf))
* tool call notifications + skill bootstrap on explicit load ([6c019cd](https://github.com/pepe57/rag-kit/commit/6c019cd3f5f01c56efc74da9ff43d5b0b4a914c3))
* true RAG pipeline with auto-managed collections and tuned presets ([e912ca5](https://github.com/pepe57/rag-kit/commit/e912ca521dc31c4389c6eea8e6b190369ff15f86))
* true RAG pipeline with auto-managed collections and tuned presets ([4fa5cd2](https://github.com/pepe57/rag-kit/commit/4fa5cd2359fc8349caf035a6069915f760b3172c))
* uniform table widths in config show ([4466dba](https://github.com/pepe57/rag-kit/commit/4466dba7251b3d19e8a09299463cfa18f025538d))
* universal run_rag_facile tool + rag-cli skill ([1e4bbfd](https://github.com/pepe57/rag-kit/commit/1e4bbfd310420e64f220205b09797efd687337fd))
* universal run_rag_facile tool + rag-cli skill ([1d46a39](https://github.com/pepe57/rag-kit/commit/1d46a3999c2afe3e8b3d69ab831adb6391647ca2))
* update_config tool, model aliases, shared console ([fe464ef](https://github.com/pepe57/rag-kit/commit/fe464ef7637e9da1861bec5125bce88d76c981e5))
* update_config tool, model aliases, shared console ([cf47f73](https://github.com/pepe57/rag-kit/commit/cf47f73aa9d938a9a76432081aef71c043921507))
* use openweight-large for dataset generation ([f382dd3](https://github.com/pepe57/rag-kit/commit/f382dd34ec6442c4ee9d51dd2abc4d29c95a6452))


### Bug Fixes

* add .prototools to workspace templates and pin Python 3.13.11 ([0df9943](https://github.com/pepe57/rag-kit/commit/0df99431bc71aadcb7be5fb5caeac55ea8c0459d))
* add albert-client to workspace dependencies and test dependencies ([8d405f8](https://github.com/pepe57/rag-kit/commit/8d405f8c4ef54915350ba87a4792475567e1b710))
* add collection ID logging to pipeline search ([8091901](https://github.com/pepe57/rag-kit/commit/80919018c426d6799618607457caadda434fdce1))
* add comprehensive error handling for SSL certificate issues in proto installation ([75522f9](https://github.com/pepe57/rag-kit/commit/75522f967279d16f0ff216e22d2a066af88e6e2f))
* add explicit exclusions to type-check moon task ([4dc84a1](https://github.com/pepe57/rag-kit/commit/4dc84a13669d0295189228fe0ce6da9e8d2add51))
* add explicit permissions block to test-install workflow ([be62466](https://github.com/pepe57/rag-kit/commit/be624666be8f455232865c2280ae2a19dfdc83d7))
* add fallback curl without SSL verification for corporate proxies ([6bc2e7e](https://github.com/pepe57/rag-kit/commit/6bc2e7e104846a0be045d05c0607a5e869fb8649))
* add GIT_WORK_TREE workaround for moon in bare repo worktrees ([a45e1e3](https://github.com/pepe57/rag-kit/commit/a45e1e3b84bd98939ce1ef5b5d9d2c45ee5b706e))
* add GIT_WORK_TREE workaround for moon in bare repo worktrees ([1563b56](https://github.com/pepe57/rag-kit/commit/1563b566e822f0f84d6ffcbb1d73fc79ba7bb50d))
* add ingestion and orchestration to monorepo setup ([a19e557](https://github.com/pepe57/rag-kit/commit/a19e557b248fb6e8f435255bb1ed9082994273d8))
* add interactive retrieval module selection to setup command ([2bba840](https://github.com/pepe57/rag-kit/commit/2bba840b791779ad944b989554e784c0b43ca858))
* add missing authentication headers to Albert API requests ([1cd1fc6](https://github.com/pepe57/rag-kit/commit/1cd1fc62f55e4545d516e2f33b03b6dd7811f906))
* add missing context and reranking packages to standalone setup ([a6e880e](https://github.com/pepe57/rag-kit/commit/a6e880e12faa950710ddbb84679b5f68defa9dc4))
* add missing context and reranking packages to standalone setup ([75c0264](https://github.com/pepe57/rag-kit/commit/75c0264596af13f714350aee3631ed2d4de9f0ce))
* add missing open_browser.py script for reflex-chat auto-open ([b2f20be](https://github.com/pepe57/rag-kit/commit/b2f20be35ce2abaca278b7dca72ece07922d3a48))
* add OpenAI SDK exclusions to generated workspace pyproject.toml ([3b022da](https://github.com/pepe57/rag-kit/commit/3b022da984005ebc64eb261a9291413606f39da1))
* add pkgutil namespace __init__.py and fix hatchling packages config ([d850889](https://github.com/pepe57/rag-kit/commit/d85088912fe9afd601ae605e6f093ed49ed6299a))
* add proto paths to GITHUB_PATH and force UTF-8 encoding on Windows ([a84d042](https://github.com/pepe57/rag-kit/commit/a84d0429a205c92a89deaa6c6f51a8facb0cebca))
* add uv tools directory to PATH on Windows ([6a3654e](https://github.com/pepe57/rag-kit/commit/6a3654e3fd6c60abd32bdb9e5fd65265380050d8))
* add verbose output and error logging to installer tests ([1c1c0e3](https://github.com/pepe57/rag-kit/commit/1c1c0e305b5b28ce46581aea1ce6abe6cd395bd4))
* address code review comments from Gemini Code Assist ([63a788f](https://github.com/pepe57/rag-kit/commit/63a788ff3bfcb484f28961f25a70250c3307d252))
* address Gemini Code Assist review comments ([9ed3b9c](https://github.com/pepe57/rag-kit/commit/9ed3b9c59cc9bd2402c9c0324e038ee5cda8e779))
* address Gemini Code Assist review feedback ([d0d0d5d](https://github.com/pepe57/rag-kit/commit/d0d0d5d263f3fa07d974576985649b9754e884c6))
* address Gemini review - sort __all__, simplify dotted_key logic ([783e3c2](https://github.com/pepe57/rag-kit/commit/783e3c20b4007b15ae57b7f0b5d2369fd8b558c3))
* address Gemini review comments on public collections ([c69cd6b](https://github.com/pepe57/rag-kit/commit/c69cd6bfcd7f00e36fb48bcbaaefbb9493768907))
* address PR [#125](https://github.com/pepe57/rag-kit/issues/125) review comments ([c2d7988](https://github.com/pepe57/rag-kit/commit/c2d7988249a9e331fd2b79fcd6a202b6ba62b132))
* address PR [#132](https://github.com/pepe57/rag-kit/issues/132) review comments ([c684454](https://github.com/pepe57/rag-kit/commit/c684454c4b7bd63f484543513830ae8b68be77d4))
* address PR [#133](https://github.com/pepe57/rag-kit/issues/133) review comments ([79dd1dc](https://github.com/pepe57/rag-kit/commit/79dd1dc68946d5c0a3a0cef64f06bd71abdf96a5))
* address PR [#134](https://github.com/pepe57/rag-kit/issues/134) review comments ([fc4ba80](https://github.com/pepe57/rag-kit/commit/fc4ba803f68c5be48e5cad93e686125ca93e6e22))
* address PR [#135](https://github.com/pepe57/rag-kit/issues/135) review comments ([67665fe](https://github.com/pepe57/rag-kit/commit/67665fef517807845b7e5c5c8767b7bbfb23dccc))
* address PR [#136](https://github.com/pepe57/rag-kit/issues/136) review comments ([625edbb](https://github.com/pepe57/rag-kit/commit/625edbba77da23451d1d38069e9d90d849b8c0cb))
* address PR [#138](https://github.com/pepe57/rag-kit/issues/138) review comments + rename chat model env var ([c633a10](https://github.com/pepe57/rag-kit/commit/c633a10d46b0fb8dff827d9382acc6354f935f28))
* address PR [#143](https://github.com/pepe57/rag-kit/issues/143) review comments ([e5acc66](https://github.com/pepe57/rag-kit/commit/e5acc66c8861ff3f37ea6486dbde1f1f2ef6200b))
* address review — missed mauve→slate + document !important ([4838d30](https://github.com/pepe57/rag-kit/commit/4838d309c5dd5366aaa9ee7ba702e4b92f54c51d))
* address review comments — gitignore, dead code, robustness ([9bc804c](https://github.com/pepe57/rag-kit/commit/9bc804c4edc851a795a2202ec60689235795064f))
* address review comments — imports, ty exclusions, solver API ([1d417f8](https://github.com/pepe57/rag-kit/commit/1d417f8b5333ab2158c2db5b5dc436b8287d0c16))
* address review comments on context injection and session naming ([b89e69e](https://github.com/pepe57/rag-kit/commit/b89e69ef9eb6ed05021ec048c437b45d5ac2820b))
* address review comments on process_query and rerank_chunks ([06de58b](https://github.com/pepe57/rag-kit/commit/06de58ba6887829936b81c651f1f5dbf7f23e2ad))
* address review comments, schema migration, and stage ordering ([704199d](https://github.com/pepe57/rag-kit/commit/704199dc7b0040047301fe4b58c64c3b7d2fb701))
* address review feedback on PR [#53](https://github.com/pepe57/rag-kit/issues/53) ([78e0710](https://github.com/pepe57/rag-kit/commit/78e07105190fd3b3c8ec39969cb1ff223fbbfb0f))
* address review feedback on PR [#54](https://github.com/pepe57/rag-kit/issues/54) ([0be49f8](https://github.com/pepe57/rag-kit/commit/0be49f8222dd06038f8b6d983d0bb8647d9f0e06))
* agent must use run_rag_facile for reads, not answer from memory ([cb3e3e7](https://github.com/pepe57/rag-kit/commit/cb3e3e7a986ccc1c5f93d569676b26ae593f7f5a))
* align albert-client version with Albert API (v0.4.0) and enable component tags ([4725817](https://github.com/pepe57/rag-kit/commit/472581754ce7eab053e31152ec5506947bf11a70))
* align albert-client version with Albert API (v0.4.0) and enable component tags ([63daa9f](https://github.com/pepe57/rag-kit/commit/63daa9f31e390d22ce37b8706bcc920acf11cedb))
* align pipeline tests with true RAG upload behavior ([8685147](https://github.com/pepe57/rag-kit/commit/8685147a712b902570198594d5490e05decdc282))
* alphabetical option ordering in generate-dataset and uninstall ([14c4b0f](https://github.com/pepe57/rag-kit/commit/14c4b0fce3acf368dc51aa5118143fa81b31cf02))
* alphabetical option ordering in setup command ([e52eb56](https://github.com/pepe57/rag-kit/commit/e52eb56d36d5669942b21349df482521a00ce85b))
* always show banner and version before any output or error ([e4047f7](https://github.com/pepe57/rag-kit/commit/e4047f77e93a45321e21acd0faeba413e8fbf063))
* always show banner before help text or error messages ([77ea4ae](https://github.com/pepe57/rag-kit/commit/77ea4ae943deeb9cbbc286b1615fc3168bbaa1c8))
* always show banner before help text or error messages ([199de21](https://github.com/pepe57/rag-kit/commit/199de217886e5cc0d4f782be155db847f6333be4))
* bundle albert-client with CLI for standalone workspaces ([d36c744](https://github.com/pepe57/rag-kit/commit/d36c7445e64ee5fa06f4a1e7252042f306a980ea))
* bundle context and reranking to correct paths for standalone setup ([9f753d9](https://github.com/pepe57/rag-kit/commit/9f753d9eca6934eb2c1ba9ecde370614dc7ac7f3))
* bundle context and reranking to correct paths for standalone setup ([a4bf035](https://github.com/pepe57/rag-kit/commit/a4bf0353508ae743b91296d3ede7af80c21f7422))
* bypass moon for app dev server to prevent dangling processes ([cbc9b59](https://github.com/pepe57/rag-kit/commit/cbc9b59ecff653fc7daf0960558182278f85aa8e))
* bypass moon for app dev server to prevent dangling processes ([a9a05c4](https://github.com/pepe57/rag-kit/commit/a9a05c48c6ed576c3b1adc5189e84dc128efa7d2))
* catch all exceptions when printing CLI banner ([8b0ed8b](https://github.com/pepe57/rag-kit/commit/8b0ed8bb16c0f151861888f57d8a121bb6ee86d9))
* catch httpx.HTTPStatusError in eval solver for Albert API failures ([2bd5457](https://github.com/pepe57/rag-kit/commit/2bd5457b756dd337a376a5bb66720bb55e59453f))
* centralize ruff config and remove unused resources directory ([552d071](https://github.com/pepe57/rag-kit/commit/552d07105c097ce881e83b0946f1db2ef2ebb13f))
* chainlit repeating all responses + handle malformed SSE ([531f056](https://github.com/pepe57/rag-kit/commit/531f05657ff5779e1bcf1836cea2629d2f5dac7e))
* check for unzip and auto-install on Linux if missing ([d67a23b](https://github.com/pepe57/rag-kit/commit/d67a23b0ae0f982c92ccca172f74c04e1dc500fe))
* **ci:** build and upload workspace zip on every release ([2be050a](https://github.com/pepe57/rag-kit/commit/2be050aa7fec92214832dea83be3b1661e69fed8))
* **ci:** build and upload workspace zip on every release ([9416479](https://github.com/pepe57/rag-kit/commit/9416479089da4d0372c60d8fae75a0bccba8b624))
* **ci:** drop --project tools so rag_facile is available when building release asset ([2cdb1c7](https://github.com/pepe57/rag-kit/commit/2cdb1c7f1931da946d463f1e318e465070887431))
* **ci:** pass GITHUB_TOKEN to installer steps to fix just 403 rate limit ([d129693](https://github.com/pepe57/rag-kit/commit/d129693a0c833c526dcd8cf7213d20d7ff2b6e0b))
* **ci:** pass GITHUB_TOKEN to installer steps to fix just 403 rate limit ([6e017bd](https://github.com/pepe57/rag-kit/commit/6e017bdc76c21fa5c13f71cfae8a790294aef07f))
* **ci:** use branch HEAD SHA in release asset to avoid PR merge commit ([039320d](https://github.com/pepe57/rag-kit/commit/039320d28dabf7a86b505893229406aef27213cb))
* config discovery and search API compatibility ([157795e](https://github.com/pepe57/rag-kit/commit/157795e51199a74e6afe2a44820d46a33531664f))
* consolidate grep|sed into single sed command ([aaa717f](https://github.com/pepe57/rag-kit/commit/aaa717f646cb90500d6230f124cac0a67dcf46d9))
* correct API usage in documentation examples ([122beaa](https://github.com/pepe57/rag-kit/commit/122beaaaee26265b58643682c6b11fdb61fc34ca))
* correct generate-dataset command in test plan ([9dcbbd5](https://github.com/pepe57/rag-kit/commit/9dcbbd50bb9f4fdcba335d4d5489518f46bcc3ef))
* correct just plugin URL from moonrepo to Phault repository ([24e06af](https://github.com/pepe57/rag-kit/commit/24e06afc4dc953f498f3efb68ced26717c6bab7d))
* correct version from 1.0.0 to 0.11.0 ([4016bb7](https://github.com/pepe57/rag-kit/commit/4016bb75f46a710fd612fa7d6c973de178a7706c))
* correct version from 1.0.0 to 0.11.0 (accidental major bump) ([6456056](https://github.com/pepe57/rag-kit/commit/64560566dcebf407c752fc78890ae208409bb817))
* create .env file at workspace root in monorepo mode ([8ae7867](https://github.com/pepe57/rag-kit/commit/8ae786717f4ae2b69c7f641db1a859e40d1e6628))
* default uninstall removes CLI only, --all for toolchain ([3bb4d52](https://github.com/pepe57/rag-kit/commit/3bb4d525d893dc9ccf7d8cd24ab92aa8f3973dc8))
* disable session memory and conversation logging in learn command ([9d54ade](https://github.com/pepe57/rag-kit/commit/9d54adea08caed5e25e9d6228ee82b963e2f445a))
* disable session memory and conversation logging in learn command ([98a2876](https://github.com/pepe57/rag-kit/commit/98a2876de288f548b0226c5eb0e436c3324683ac))
* display CLI commands in alphabetical order ([37a2d57](https://github.com/pepe57/rag-kit/commit/37a2d570dbd3b15be99e665a4fe7ad8b9fb1c9ef))
* display storage backend in config show command ([bac5bb9](https://github.com/pepe57/rag-kit/commit/bac5bb9a90441136865fc9239d343702fe9cb786))
* **docs:** correct reranker model — openweight-rerank is BAAI/bge-reranker-v2-m3 ([2b61048](https://github.com/pepe57/rag-kit/commit/2b61048a12d9f2f89679fe42ce3c951f4576d82d))
* enforce two-step confirmation before update_config tool call ([d2aa5a3](https://github.com/pepe57/rag-kit/commit/d2aa5a3bf9185f73a3f4311394aa2a8b5cd0b0ae))
* export PATH to GitHub Actions environment for CI/CD ([eadf6b3](https://github.com/pepe57/rag-kit/commit/eadf6b32d92335f0a35580067de07a3244fa291d))
* ground dataset generation in actual document content ([21606b9](https://github.com/pepe57/rag-kit/commit/21606b93800f94bc1138dc8f96e60dd125c57f6e))
* handle Albert API 429 rate limit with auto-retry in chat loop ([c315710](https://github.com/pepe57/rag-kit/commit/c315710a3405769024b6ed4e9d0e20f105db9e32))
* handle Windows encoding issues in CI and CLI ([e672345](https://github.com/pepe57/rag-kit/commit/e672345e2a03279f0897119ecdcb8d41e382bcd9))
* harden skill routing against hallucination ([4d0f831](https://github.com/pepe57/rag-kit/commit/4d0f831eef4cdabc8865323e901e16abed327a33))
* harden skill routing against hallucination ([dddb619](https://github.com/pepe57/rag-kit/commit/dddb619402483197300db3d72c6624cc8eb5619f))
* ignore Chainlit translation files in nested paths ([ab50b8c](https://github.com/pepe57/rag-kit/commit/ab50b8c7a6ddeb4f8164ad34187467cf83e7a619))
* ignore Chainlit translation files in nested paths ([1e62d7c](https://github.com/pepe57/rag-kit/commit/1e62d7cf59707793e369574a46358d6838a3e756))
* improve error handling by downloading proto installer to temp file ([9016286](https://github.com/pepe57/rag-kit/commit/9016286f45514869f64a6435cb6a0b6e5e6572d4))
* include preset public collections in generated standalone config ([6d6d73b](https://github.com/pepe57/rag-kit/commit/6d6d73b102bfded860964af004655119a3107754))
* include preset public collections in generated standalone config ([83d2c45](https://github.com/pepe57/rag-kit/commit/83d2c45ab2e7691d48988d25a55e81c491ee667d))
* increase retrieval depth for better recall on long sections ([48de5c4](https://github.com/pepe57/rag-kit/commit/48de5c4c94052f1cb9329deb7bf55779525b54df))
* inject memory into first user turn instead of system prompt ([13699ec](https://github.com/pepe57/rag-kit/commit/13699ec67ab815702d364619429fb7deea3ab327))
* install scripts now default to latest release tag instead of main ([de24615](https://github.com/pepe57/rag-kit/commit/de246155e1a99efdc4d3e3897b698bbb0eb6a883))
* install scripts now default to latest release tag instead of main ([8be87bb](https://github.com/pepe57/rag-kit/commit/8be87bb68bb9c42ef3f78505cc6c7c8e3a4257a0))
* language-first wizard order and localised chat UI ([fc332c5](https://github.com/pepe57/rag-kit/commit/fc332c56e3cd6b1692df841da7af1d8ff839d779))
* localise no-workspace hint in welcome panel ([4d3658d](https://github.com/pepe57/rag-kit/commit/4d3658daede61a7804e0b83e108bf896298d9a5e))
* make Albert RAG first choice, remove broken Chainlit config gen ([a4332bc](https://github.com/pepe57/rag-kit/commit/a4332bcb33a6c1735a7f491a6369a4216f4c6324))
* make Collection model fields optional for create response ([8e18529](https://github.com/pepe57/rag-kit/commit/8e185297eae58010f809f4b856fb8382aa9395f1))
* make curl command in gh issue dynamic based on HTTP method ([119cff2](https://github.com/pepe57/rag-kit/commit/119cff2068ea25e2cb883969bee9b7b97e577f2d))
* make retrieval-albert interchangeable with retrieval-basic ([4f993cc](https://github.com/pepe57/rag-kit/commit/4f993cce42c381de04b0e9b035bd9b91852842ae))
* monorepo templates conditionally use retrieval-basic or retrieval-albert ([1ffa0cf](https://github.com/pepe57/rag-kit/commit/1ffa0cf7bcc33175fc7c4de5528f73485e556262))
* move base URL to presets and remove setup prompt ([cfc65cc](https://github.com/pepe57/rag-kit/commit/cfc65cc29a91ec5ea17c5c90b6914b753798d463))
* move proxy env vars to installer step to avoid checkout failures ([ee33c05](https://github.com/pepe57/rag-kit/commit/ee33c059a29b3105676a123b016af06a851514cd))
* normalize text before token-F1 (strip punctuation, lowercase) ([5b7958b](https://github.com/pepe57/rag-kit/commit/5b7958b9468b8a7631a8a967707b939f72fa6aec))
* pass module name to Inspect AI instead of absolute path ([0725c5e](https://github.com/pepe57/rag-kit/commit/0725c5e5ea9a330597046a1fd47c1b5425c563a1))
* pass RAG_FACILE_BRANCH env var to installers in workflow ([5936cc5](https://github.com/pepe57/rag-kit/commit/5936cc514c1a3c2e9cd3cdb6b027d09a2603d486))
* pin Python 3.13.11 across all toolchain configurations ([19f68b6](https://github.com/pepe57/rag-kit/commit/19f68b6c0b8060b841e2bd415a6a116e0de0530b))
* pin workspace deps to git SHA instead of version tag ([e2c95b8](https://github.com/pepe57/rag-kit/commit/e2c95b8163bfcb9c13129ae102228b0f69518751))
* populate relevant_contexts in dataset loader for recall/precision scorers ([4d9833f](https://github.com/pepe57/rag-kit/commit/4d9833f058f964ee8ff76f9431a707bc0ffd4fc3))
* precision_at_k returns 1.0 when no chunk IDs defined ([cb15694](https://github.com/pepe57/rag-kit/commit/cb156945cb3fda15abd668e05d5c59d497dd43f4))
* preserve proxy environment variables when running proto installer ([f7271cc](https://github.com/pepe57/rag-kit/commit/f7271ccdd79e4177f294d24357d1154a77cce03b))
* preset strategies not applied — stale bundled TOML files ([f3cd9e4](https://github.com/pepe57/rag-kit/commit/f3cd9e40dacbdf0cae2c5c4bed0d1c7b0119cb93))
* prevent install.sh from exiting when no proxy is detected ([7418f99](https://github.com/pepe57/rag-kit/commit/7418f99159578a3f125e2f4dda5ecafabc78c00c))
* rate limit retry loops indefinitely until Ctrl+C ([baa82b3](https://github.com/pepe57/rag-kit/commit/baa82b35afbda10210a84b1a675a7756016c44b5))
* reflex app crashes on malformed SSE events from Albert API ([6c41d7d](https://github.com/pepe57/rag-kit/commit/6c41d7dc12998c780ccb110f14285cac24aa56de))
* regenerate templates with albert-client dependency ([094be96](https://github.com/pepe57/rag-kit/commit/094be96021a8c1e5e9fffd5f43a569af7b0c1d78))
* remove --public flag, add real MediaTech collection IDs to presets ([c301381](https://github.com/pepe57/rag-kit/commit/c3013814b4a857548c28d74886ad4c8a6f0dde21))
* remove double confirmation from update_config — resolves terminal freeze ([a4ea2ea](https://github.com/pepe57/rag-kit/commit/a4ea2ea54b12d948d6eb39d989f72a066f8d0726))
* remove extra blank lines in cli README ([fc3eb90](https://github.com/pepe57/rag-kit/commit/fc3eb9079acfdc72ac7ee995168380d2db24f0d8))
* remove JSON file type from Albert ingestion provider ([17fd077](https://github.com/pepe57/rag-kit/commit/17fd07714edfcb89f9bacf3384a5f95b6395f473))
* remove JSON file type from Albert ingestion provider ([60fb436](https://github.com/pepe57/rag-kit/commit/60fb436e1a909ed75803edf860e80dbd68e5a124))
* remove macOS Intel (macos-12) test - runners not available ([ba2a511](https://github.com/pepe57/rag-kit/commit/ba2a511c1f96a734053cf81d63afe5cbcbef2618))
* remove nested PowerShell call in Windows CI test ([b61a826](https://github.com/pepe57/rag-kit/commit/b61a82663cc13ff78eb06a0ef2412155f0ecac12))
* remove proxy simulation jobs from test-install workflow ([7eb2b9e](https://github.com/pepe57/rag-kit/commit/7eb2b9e1fdfaf2a7de4c9dcb55b6233c0baf1eea))
* remove search and sources (list) commands from eval ([d171427](https://github.com/pepe57/rag-kit/commit/d1714277615370f7be1719427290d082e48cecb0))
* rename albert_rag provider for clarity ([33ef440](https://github.com/pepe57/rag-kit/commit/33ef440e61c36c340d9e846231c86e6f9e6a5fa7))
* rename app.py to match Reflex app_name requirement in standalone workspaces ([9c20691](https://github.com/pepe57/rag-kit/commit/9c2069187bbe548128487198a093aa2757df31c6))
* rename Reflex app package dir after moon generate ([e501d21](https://github.com/pepe57/rag-kit/commit/e501d2153a0f625537f999d7aff47430f3f56812))
* replace process substitution with file download for installer ([051698d](https://github.com/pepe57/rag-kit/commit/051698d89932aad5a5b6bd89fc3ae9296caaa492))
* resolve CI test failure from Rich ANSI codes in assertion ([79bc659](https://github.com/pepe57/rag-kit/commit/79bc65911313e1e1913f39b3b86f4ab2b47266b0))
* resolve issue [#46](https://github.com/pepe57/rag-kit/issues/46) - add proxy support for proto plugin installation ([c1aa693](https://github.com/pepe57/rag-kit/commit/c1aa693431af04f7278348be682981c12484b36b))
* resolve ruff formatting issues ([b457b5c](https://github.com/pepe57/rag-kit/commit/b457b5ccde42421337f791aee76a31b6091cb494))
* resolve trace database path relative to workspace root ([63f3692](https://github.com/pepe57/rag-kit/commit/63f3692314a1d26d07222b920ef7fb02b3c00901))
* resolve ty type check errors in letta provider and tests ([ef83e2c](https://github.com/pepe57/rag-kit/commit/ef83e2c546564fc149ce7f7065fcfed6cebbf8b6))
* resolve ty type checking issues in setup and reflex app ([92f8c25](https://github.com/pepe57/rag-kit/commit/92f8c254e4bed900eb3d2f40bc3865264b622e0b))
* respect disabled collection toggles in chat apps ([5500b9b](https://github.com/pepe57/rag-kit/commit/5500b9b19e4a767fee6003d7b26a896bde31c314))
* respect disabled collection toggles in chat apps ([a7f03cb](https://github.com/pepe57/rag-kit/commit/a7f03cb73817aef32ca56f42348fed3d2e9b211d))
* restore browser opener in reflex-chat moon.yml ([f6bbae2](https://github.com/pepe57/rag-kit/commit/f6bbae22324e955dd69e6b6e02af3b07874b724d))
* restrict file types to Albert API-supported formats ([dc25e79](https://github.com/pepe57/rag-kit/commit/dc25e79601cd2c1ade8716d87c5c46b5ee4730e4))
* restrict file uploads to supported formats in Chainlit app ([fb56f4c](https://github.com/pepe57/rag-kit/commit/fb56f4c3bf45ece042bd8c8105b0c5cba357a03d))
* revert dark mode button color to match DSFR purple/lavender ([37ac0c2](https://github.com/pepe57/rag-kit/commit/37ac0c266462e5fc2649f6a567f0cc5877f0d911))
* search for unique chunk IDs for each generated question ([65034b8](https://github.com/pepe57/rag-kit/commit/65034b879bebfade6d63854a776cca6a847b5f64))
* set balanced preset as default selection in prompt ([8f054a5](https://github.com/pepe57/rag-kit/commit/8f054a5da0ae1176fe9dd1cdfe7ae9681452f3ad))
* setup closing message shows both just run and rag-facile with real path ([6a619f6](https://github.com/pepe57/rag-kit/commit/6a619f6f655d3229f8e8558a514fba21465836d9))
* simplify test-install workflow to only verify tool installation ([2d313f8](https://github.com/pepe57/rag-kit/commit/2d313f81df3d5ec0a5e646fefb724f75adb9bfba))
* skip session commit silently when .rag-facile/ is gitignored ([4969317](https://github.com/pepe57/rag-kit/commit/4969317f19e92fabd8247b146d1327b2cd24c2ea))
* source shell profile in workflow verification steps ([95761d5](https://github.com/pepe57/rag-kit/commit/95761d580855bfe0c29088604cd1ebb311687335))
* stop generating pipeline packages in monorepo, add src/ to standalone ([174e855](https://github.com/pepe57/rag-kit/commit/174e85500a96a0ad56d7850104ee7b2969f3a2cb))
* stop wizard falling through to second question on Ctrl+C ([0777307](https://github.com/pepe57/rag-kit/commit/0777307205b90937311207a413dcfe1716eb6deb))
* strengthen Albert provider prompt to enforce JSONL-only output ([d735430](https://github.com/pepe57/rag-kit/commit/d735430f1740718449b2eeb50612e3bc4526baa5))
* strengthen Letta provider prompt to enforce JSONL-only output ([c6f1bba](https://github.com/pepe57/rag-kit/commit/c6f1bbae1474eb8b1829f95beb3fd791c4c392a3))
* suppress smolagents error output and clean up workspace display ([e4f0fbb](https://github.com/pepe57/rag-kit/commit/e4f0fbba2c2d848790adb0493eed4aea48f2a61a))
* three bugs in dataset generation ([b82fb48](https://github.com/pepe57/rag-kit/commit/b82fb48e7154c839292334905bd1765ec714dc5e))
* update CLI to match refactored Albert provider ([b054452](https://github.com/pepe57/rag-kit/commit/b054452cac46dc608889dc62203a9c9ce5f91cb7))
* update extra-files to match renamed packages and sync versions ([9d721fd](https://github.com/pepe57/rag-kit/commit/9d721fd4dd2e7ee927b20715212356e86b339a66))
* update extra-files to match renamed packages and sync versions ([3437926](https://github.com/pepe57/rag-kit/commit/3437926a45a8fac2abc9e3bc624285c945540288))
* update golden master modules.yml from stale pdf_context ([1a551a7](https://github.com/pepe57/rag-kit/commit/1a551a796af2280fb725992823a6537489e32a1d))
* update install script to reference current setup command ([c06a947](https://github.com/pepe57/rag-kit/commit/c06a947c5593a0ea36db6c2a8aa85468211787cc))
* update install script to reference current setup command ([6ac8d99](https://github.com/pepe57/rag-kit/commit/6ac8d99464116745aabbec2c94515fc3d00edffa))
* update remaining eval.providers references in test_document_preprocessor.py ([f0a423f](https://github.com/pepe57/rag-kit/commit/f0a423f1d1f5de28b07a0022a93edad649b8e29a))
* update search() to use query/collection_ids per Albert API v0.4.1 ([f123ad7](https://github.com/pepe57/rag-kit/commit/f123ad7e2e9a4a9ef81a5d5b6f5684fe79b4bdd3))
* update setup command to use unified retrieval template ([65d11ba](https://github.com/pepe57/rag-kit/commit/65d11baac91808fa17ca9daa5cf11a286f19470d))
* update test to expect new template name after module renaming ([1d5e916](https://github.com/pepe57/rag-kit/commit/1d5e9161eb5cf235df83608aed3e73e07ced814d))
* update workspace generation for phase-based package structure ([8beb8d3](https://github.com/pepe57/rag-kit/commit/8beb8d3f392e18a0216042f7e85fa50fa67e3a99))
* use Albert API model aliases instead of raw model IDs ([ea5c5b9](https://github.com/pepe57/rag-kit/commit/ea5c5b9681d86cb00abe7172afea1afb93616a40))
* use Chainlit i18n for welcome message instead of hardcoding ([7327ea1](https://github.com/pepe57/rag-kit/commit/7327ea106cd0fc0a87a067f6f8f32c885e8323ca))
* use ChatSettings for collection toggles and deduplicate IDs ([18ae23c](https://github.com/pepe57/rag-kit/commit/18ae23c015817488b26b374143c47353898d1e94))
* use correct Albert API model aliases in documentation ([a9fcd03](https://github.com/pepe57/rag-kit/commit/a9fcd035e851f307a3576d04802cce1a28c85dca))
* use correct AlbertClient API method names ([f52b3d1](https://github.com/pepe57/rag-kit/commit/f52b3d18641b2cb0cbfca6bb0e979afb88422f8e))
* use correct GitHub raw content URL format with refs/heads ([93087e0](https://github.com/pepe57/rag-kit/commit/93087e0756f5bb0964ec9c28a16f2b0787713c2d))
* use date-sorted release badge to avoid shields.io semver bug ([54586ef](https://github.com/pepe57/rag-kit/commit/54586efc80f858955ed3efd174199d4d27a53426))
* use date-sorted release badge to avoid shields.io semver bug ([8d6175a](https://github.com/pepe57/rag-kit/commit/8d6175a7e882072fa3f67004ed45f1a14d734660))
* use get_running_loop() and handle empty context in eval solver ([88c3df4](https://github.com/pepe57/rag-kit/commit/88c3df4c32ccf9be2785eb9cf79daa4d979039a9))
* use GITHUB_ENV to persist PATH across workflow steps ([64343cf](https://github.com/pepe57/rag-kit/commit/64343cf11a3da89c82b0555ffe0f9a75adb62476))
* use GITHUB_PATH for uv tools directory in CI ([86b4d35](https://github.com/pepe57/rag-kit/commit/86b4d357528de0eafcdd817742eaa6d66702d3c3))
* use github.head.ref for PR testing to avoid 404 errors ([5589820](https://github.com/pepe57/rag-kit/commit/558982041502d921e99859420aca837aee12ea47))
* use Inspect AI Python API instead of subprocess CLI ([ab99b48](https://github.com/pepe57/rag-kit/commit/ab99b484c9ca8d498016724690e12bb923d2cc1a))
* use ragfacile.toml config as fallback for OPENAI_MODEL ([7f80f2f](https://github.com/pepe57/rag-kit/commit/7f80f2f2dae55abd462447a458b36fd7bdf07f37))
* use set_color_mode from reflex.style for Reflex 0.8.27 ([ae78a80](https://github.com/pepe57/rag-kit/commit/ae78a8013feb9a4bd46cc1b00218ebf394387dcf))
* use static directory names in reflex-chat template for Windows compatibility ([87a4f1f](https://github.com/pepe57/rag-kit/commit/87a4f1fc5bb6b50660f2f0b6e5b898b0b0063d64))
* use subexpression syntax for variable interpolation in PowerShell install script ([d0221e6](https://github.com/pepe57/rag-kit/commit/d0221e61e6365fd4ca05b92c7c2236e75b99cc55))
* **windows:** install just from GitHub Releases binary zip ([c1899ba](https://github.com/pepe57/rag-kit/commit/c1899ba2b2924bcb805df44a75e25e7ea85226e3))
* **windows:** replace non-ASCII chars in install.ps1 ([0add5ed](https://github.com/pepe57/rag-kit/commit/0add5ed3efc0e314292db5ba61263715e6515b6e))


### Documentation

* docs:  ([3064ed2](https://github.com/pepe57/rag-kit/commit/3064ed21f0ea4d2c53fa045735e1279f4abfc8b9))
* add Albert API provider documentation ([b1f56d4](https://github.com/pepe57/rag-kit/commit/b1f56d45197ee81ff12111a65dad9f612afb1ea4))
* add Albert Client SDK documentation ([eeb5d8d](https://github.com/pepe57/rag-kit/commit/eeb5d8d7332910812e10bc0862f4fecbd0eb7436))
* add Albert Client SDK with audience-focused documentation ([6a3a51e](https://github.com/pepe57/rag-kit/commit/6a3a51e7e3c8126ca34ed08ec4054cded5ead16b))
* add comprehensive test plan for component-first architecture ([07146d9](https://github.com/pepe57/rag-kit/commit/07146d905c3eeb2034853918c7e29205b53b53c2))
* add comprehensive Windows support documentation ([871e8fd](https://github.com/pepe57/rag-kit/commit/871e8fd6c61cf8294178868072307143573f508a))
* add Linux and macOS CI/CD testing guides with comprehensive workflow ([a2b9189](https://github.com/pepe57/rag-kit/commit/a2b9189019b51ffdfe268bac460fdea0717e002c))
* add missing paper title in rag-science Key Papers table ([74e6085](https://github.com/pepe57/rag-kit/commit/74e6085121cce4460832500f5158c60cba3d2dd7))
* add RAG science guides (end-user + contributor reference) ([31acdaf](https://github.com/pepe57/rag-kit/commit/31acdafe74996a29979abc1659fcb1b0488cfd0e))
* add RAG science guides (end-user + contributor reference) ([eb1ac01](https://github.com/pepe57/rag-kit/commit/eb1ac018c1b3bd03ae1a768dd87cde960631e090))
* add Windows upgrade commands ([b46a1c2](https://github.com/pepe57/rag-kit/commit/b46a1c25ea69c6158cde06a914a62250d12e0829))
* add worktrees guide for bare repo + worktrunk workflow ([e1d8762](https://github.com/pepe57/rag-kit/commit/e1d876270d1ad18297f456a048da58922c4edbd1))
* add worktrees guide for bare repo + worktrunk workflow ([06b2294](https://github.com/pepe57/rag-kit/commit/06b2294a640317526841939f65b9dd120b66f5dc))
* **albert-client:** document model aliases and api version ([c606fe4](https://github.com/pepe57/rag-kit/commit/c606fe4f56bba506508ba27433270ee1a3c1da9b))
* **albert-client:** improve docstrings and address PR review ([cbf5dce](https://github.com/pepe57/rag-kit/commit/cbf5dce13e6d861d64b859e824f39c46becd8b5d))
* align documentation wording on just and moon commands ([d8f8a66](https://github.com/pepe57/rag-kit/commit/d8f8a66cb02c4901679e9c8558f316865ec5deb9))
* align documentation wording on just and moon commands ([581feb8](https://github.com/pepe57/rag-kit/commit/581feb89f58126148ac7b86ea8b044033e687dc2))
* clarify albert-client is outside rag_facile.* namespace ([41c8226](https://github.com/pepe57/rag-kit/commit/41c8226fbb2dbdf06829eb9794692175c67fd345))
* comprehensive documentation for RAG configuration system ([13c3043](https://github.com/pepe57/rag-kit/commit/13c30437f584e454718a51eb6fb546e02b43ad8b))
* comprehensive documentation for RAG configuration system ([b7b0eec](https://github.com/pepe57/rag-kit/commit/b7b0eecb4e23300bbec1c322b3b3aaf054ac1d21))
* fix cp path and remove duplicate wt config block ([ed12336](https://github.com/pepe57/rag-kit/commit/ed123362ab18ec5b46ca491653c5d062821e25a0))
* fix install instructions for macOS/zsh compatibility ([8c27ef3](https://github.com/pepe57/rag-kit/commit/8c27ef31f24911ff5f72c276251ef5289a0affe6))
* fix install instructions for macOS/zsh compatibility ([1d336f6](https://github.com/pepe57/rag-kit/commit/1d336f6e987f9807ef257f0b07f0aa7a227680c3))
* fix redundant code fences in README files ([b96f4f0](https://github.com/pepe57/rag-kit/commit/b96f4f0c9b86c428d83c0ea3d7519fb494f599e1))
* improve type safety documentation in albert-client SDK ([dc7d2af](https://github.com/pepe57/rag-kit/commit/dc7d2afddf9de71b5fb289d5e6b453a93f6c299d))
* refactor README into focused documentation files ([c53e312](https://github.com/pepe57/rag-kit/commit/c53e312b011ba60d2e40cc7ad389a48f73cd70ba))
* refactor README into focused documentation files ([68c06a7](https://github.com/pepe57/rag-kit/commit/68c06a762179dbcf6df4f1a30643f8683bdc8cb2))
* remove historical Issue 46 investigation files ([f35589b](https://github.com/pepe57/rag-kit/commit/f35589b3de5fc7d703e1c301526c0959d43a1ba8))
* reorganize documentation into dedicated docs directory ([1e43a1f](https://github.com/pepe57/rag-kit/commit/1e43a1f1d1b11f632c7e6dcf471b1397edaf6f99))
* translate French content to English and add config system documentation ([87f67cd](https://github.com/pepe57/rag-kit/commit/87f67cd8fed4dd85ff591af6fbdda6939c8f17ed))
* update AGENTS.md with comprehensive current project knowledge ([cf15658](https://github.com/pepe57/rag-kit/commit/cf15658ff58ae592b3a119619cfa8b36c54c51b0))
* update CONTRIBUTING, AGENTS, TEST_PLAN for rag_facile namespace ([9e86742](https://github.com/pepe57/rag-kit/commit/9e867423c65252fb21e27348740f60174ab9630a))
* update CONTRIBUTING, AGENTS, TEST_PLAN for rag_facile namespace (PR [#121](https://github.com/pepe57/rag-kit/issues/121)) ([0fdb02a](https://github.com/pepe57/rag-kit/commit/0fdb02a80e8eff90e63d64f4dbda2928399b8c36))
* update documentation for eval generate improvements ([041b8fc](https://github.com/pepe57/rag-kit/commit/041b8fcfb31f00fd00144a3ec805c174887633b4))
* update for Albert RAG component and retrieval modules ([052792c](https://github.com/pepe57/rag-kit/commit/052792cc3daf658c314a9bc153ec745eeb822ebc))
* update imports and project structures for rag_facile namespace ([a6f8e84](https://github.com/pepe57/rag-kit/commit/a6f8e840080761faa8ecde7b31175904c3d3e637))
* update presets and documentation for query expansion ([dd9492e](https://github.com/pepe57/rag-kit/commit/dd9492e0b60cefdc3dfc521b7bd6092450835611))
* update test plan to document config precedence for OPENAI_MODEL ([cbcbc1a](https://github.com/pepe57/rag-kit/commit/cbcbc1a8d08d1e59490e82410c4c3fc6e64feb33))
* update test plan to reflect automatic template regeneration ([a2bee94](https://github.com/pepe57/rag-kit/commit/a2bee941d9733ce6ef11f1c206f1af44769edfe7))
* update test plan to use just commands consistently ([3a0b838](https://github.com/pepe57/rag-kit/commit/3a0b838466eb66b25bf91176140bc048c53179be))
* use just run instead of raw uv commands in documentation ([6bfa9b3](https://github.com/pepe57/rag-kit/commit/6bfa9b376568b67993c5db00ada781d38f951e09))
* use just run instead of raw uv commands in documentation ([49f3c2d](https://github.com/pepe57/rag-kit/commit/49f3c2ddcaa529c2af169691ffd181c69959b276))


### Code Refactoring

* consolidate citation config and unify schema terminology ([065e41b](https://github.com/pepe57/rag-kit/commit/065e41bdfbc8cbec9cc26dca1e013567718ed8e8))
