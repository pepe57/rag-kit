...
## [0.21.0](https://github.com/pepe57/rag-kit/compare/v0.20.0...v0.21.0) (2026-03-13)
...
* add Supabase infrastructure and SQL migrations with RLS ([f5ef1d9](https://github.com/pepe57/rag-kit/commit/f5ef1d98cb1fae7a87a2da25a77591b3ece502d5))
...
* **albert-client:** add /me/info and /me/keys management methods ([858010d](https://github.com/pepe57/rag-kit/commit/858010df40e24102209a50ef738fb461dcf3167f))
...
* **albert-client:** update to Albert API 0.4.1 ([e65898d](https://github.com/pepe57/rag-kit/commit/e65898d231273e62bf461e87142b8c9b75ae59fd))
...
* **chainlit:** add Supabase auth and conversation persistence ([771d485](https://github.com/pepe57/rag-kit/commit/771d48582a0f2a08015a2fcaae944d51e1807b04))
* **chainlit:** read display_name from Supabase user metadata ([15544e5](https://github.com/pepe57/rag-kit/commit/15544e5434d416151ce7123b5bd6dbbedc89f0c7))
* **chainlit:** Supabase auth and conversation persistence ([9b8dc58](https://github.com/pepe57/rag-kit/commit/9b8dc5889786648f0dfcecb7db965d81d2e43d2f))
...
* full French UI + dot spinner for uv install step ([7f87dd8](https://github.com/pepe57/rag-kit/commit/7f87dd8bacd0db48f596a6c4481ae7d2aa162f40))
...
* memory search — keyword + optional Albert semantic search ([1a8dace](https://github.com/pepe57/rag-kit/commit/1a8dace73a90cad3ef0fa1769a04e1f87a1268d2))
* memory search — keyword + optional Albert semantic search ([9907666](https://github.com/pepe57/rag-kit/commit/99076669d5a5d211757d9798b65716299cc41455))
* move API key prompt to start of install (before dependencies) ([126ec54](https://github.com/pepe57/rag-kit/commit/126ec54e080f580fa06770869589d8c702155ac3))
...
* prompt for Albert API key during install and write .env ([3a05f46](https://github.com/pepe57/rag-kit/commit/3a05f467e0741ed054c572b288107b61c21037a7))
* prompt for Albert API key during install and write .env ([917b41b](https://github.com/pepe57/rag-kit/commit/917b41bf62a088094da208387dfeb8bbf085692f))
* prompt for Albert API key in Windows installer (install.ps1) ([821e58c](https://github.com/pepe57/rag-kit/commit/821e58c7f46cab170d04e9905a1bc4dbd084540d))
...
* Supabase PostgreSQL storage for tracing ([425b5eb](https://github.com/pepe57/rag-kit/commit/425b5eb9d32c9647c72014bc311785fa346efb5e))
* Tier 1 format enforcement — few-shot, format anchor, validator+retry ([b5f2664](https://github.com/pepe57/rag-kit/commit/b5f26648db853226ca800b423f6a0d2c5b096055))
...
* **tracing:** add PostgresProvider for Supabase/PostgreSQL tracing ([8ca0d08](https://github.com/pepe57/rag-kit/commit/8ca0d08a8bab250e415f0751d50ac7bbb771136b))
...
* update albert-client to API 0.4.1 ([f3d9968](https://github.com/pepe57/rag-kit/commit/f3d9968bef333a763e6e10c418fe2851c7669352))
...
* adapt learn assistant tone and verbosity to user experience level ([65f9683](https://github.com/pepe57/rag-kit/commit/65f9683bf129e5dff3b089ed961ccfea55483b90))
* adapt learn assistant tone and verbosity to user experience level ([070cc0b](https://github.com/pepe57/rag-kit/commit/070cc0b219c32f93aa4fdcad6701ec7191e65fb2))
...
* add complete response example to newbie style instruction ([136b797](https://github.com/pepe57/rag-kit/commit/136b7979bba6fffba04e40dafe472c9e2141cbdc))
...
* add rag-facile architecture facts to prevent LLM hallucination ([3195351](https://github.com/pepe57/rag-kit/commit/319535184b85415bea6011420a9e754662b69e34))
...
* address PR [#195](https://github.com/pepe57/rag-kit/issues/195) review comments ([571272a](https://github.com/pepe57/rag-kit/commit/571272a08e827ffa036d151363c500a0873c3eeb))
...
* align get_docs() trigger with system prompt rules, prefer live data ([0c6b1c4](https://github.com/pepe57/rag-kit/commit/0c6b1c4e1eab076d76dfa48d9bf74901e73fc254))
...
* allow get_docs() for rag-facile specific facts, block for RAG concepts ([589aca4](https://github.com/pepe57/rag-kit/commit/589aca4031b4d7b1608ae69b56889ed222d79e6d))
...
* always default to French — remove locale detection, add language instruction ([92ff5f5](https://github.com/pepe57/rag-kit/commit/92ff5f54a5a9bc719c4c30dab4856dbd687baea8))
* always pin generated workspaces to latest GitHub release ([9b4e844](https://github.com/pepe57/rag-kit/commit/9b4e844e740981f924904459b1479770435c5ec5))
* always pin generated workspaces to latest GitHub release ([5c04fda](https://github.com/pepe57/rag-kit/commit/5c04fdaac9a9d6e02db3ee9ab233440ebf2c8cf8))
...
* block get_docs() for new users — doc retrieval was the root cause ([65ec5d4](https://github.com/pepe57/rag-kit/commit/65ec5d4a8a18096a6fd890391bc0c4bc7455041a))
...
* **chainlit:** address review comments on auth and persistence ([e18e9f7](https://github.com/pepe57/rag-kit/commit/e18e9f78e8b5c5b14fa3ad11e0bbf2512bf15487))
* **chainlit:** import ThreadDict from chainlit.types, not cl namespace ([2f27e0c](https://github.com/pepe57/rag-kit/commit/2f27e0cc69ec0266f8daa29624c17ce1c7e5f994))
* **chainlit:** require CHAINLIT_AUTH_SECRET for auth login ([ca1b874](https://github.com/pepe57/rag-kit/commit/ca1b874dca319a27a1f095056fed4853ee8b8615))
* **chainlit:** show email as display_name in user menu ([4292c6b](https://github.com/pepe57/rag-kit/commit/4292c6bf06330fc38244e343dc3255dbdd9e6f40))
* change ingestion provider default from "albert" to "local" in presets ([1a473aa](https://github.com/pepe57/rag-kit/commit/1a473aa6b71ed166175d61ee6a4f1bd9c566e9e5))
...
* **ci:** allow PEP 440 post/dev/rc suffixes in albert version check ([bd6ba93](https://github.com/pepe57/rag-kit/commit/bd6ba93ffd3081d6b4292492d0da578fab2dc61c))
...
* correct upgrade-pkg recipe to use uv lock --upgrade-package ([b208b88](https://github.com/pepe57/rag-kit/commit/b208b8818a7bba969d937554e9078fe3372e51a1))
...
* download just from GitHub Releases directly (bypass just.systems CDN) ([8270b8f](https://github.com/pepe57/rag-kit/commit/8270b8fe8bba3c6221868218eb1cf281e94e58f4))
...
* ensure initial git commit works on fresh machines without git user config ([ec30e6f](https://github.com/pepe57/rag-kit/commit/ec30e6fdcda9b4993bf0f02b300235f3f5eae555))
* ensure initial git commit works on fresh machines without git user config ([6d8b684](https://github.com/pepe57/rag-kit/commit/6d8b684d4d1462c20e153cf732ed82b90a6bebca))
* glossaire entries as bullet list (- prefix) for vertical rendering ([962a101](https://github.com/pepe57/rag-kit/commit/962a101d8b0376d5208c4d7e67512daf48b8a422))
...
* inject language instruction into agent system prompt ([6cac5ff](https://github.com/pepe57/rag-kit/commit/6cac5fff67dcc099ef18970d1b84413864b836c5))
* inject language instruction into agent system prompt ([addd872](https://github.com/pepe57/rag-kit/commit/addd872ae2eeb2abe8e8c57dd58d19ac9b7db581))
...
* install just via uv tool install rust-just ([cc2d73c](https://github.com/pepe57/rag-kit/commit/cc2d73c7e55efb6e6c644b24f40d8d63e425af6f))
...
* **migrations:** add deletedAt column to Thread table ([05a0802](https://github.com/pepe57/rag-kit/commit/05a080215a3fa4a8e3525814dcf620b56b15dd1b))
* **migrations:** nullable Step.threadId, non-null Thread.metadata default ([a41facb](https://github.com/pepe57/rag-kit/commit/a41facb55558af8d15dc89c556fec4893e15039f))
* **migrations:** use PascalCase table names matching ChainlitDataLayer ([1c9669a](https://github.com/pepe57/rag-kit/commit/1c9669a7a4027da38bdce7d799daedd0de5d7123))
...
* newbie responses — plain language + glossary-last for technical terms ([c5955f5](https://github.com/pepe57/rag-kit/commit/c5955f5943501414174df3ea02cf5fde4a431dad))
...
* pass GITHUB_TOKEN to install.sh to avoid API rate limits in CI ([81a6f99](https://github.com/pepe57/rag-kit/commit/81a6f99a99340c99d5335fba8081264e5d96e039))
...
* promote newbie format to STRICT RULE and enforce in explain-rag skill ([90c6a6c](https://github.com/pepe57/rag-kit/commit/90c6a6cb616de70fcdfd7b10681a5db42f6b29b8))
...
* remove language question from init wizard — detect from system locale ([a075048](https://github.com/pepe57/rag-kit/commit/a075048c47ae571fc30ab9bfc0ab3bb18a8cb809))
* remove language selection from learn init wizard — always French ([4aa699c](https://github.com/pepe57/rag-kit/commit/4aa699ccc91d3b9dcb9c9cda100de2d0c5b54e71))
* remove language selection from learn init wizard — always French ([b3433e6](https://github.com/pepe57/rag-kit/commit/b3433e6329837e32676ec23d270dcc9df655629a))
...
* replace char-by-char star loop with silent read for paste support ([ba7351c](https://github.com/pepe57/rag-kit/commit/ba7351ca7b1d8e8b28c33d76c92d95607b9ad5cc))
...
* respond in French by default, follow user language if they switch ([2cbbc70](https://github.com/pepe57/rag-kit/commit/2cbbc70e6b160c5385ca9781d56d1a0785a57dd8))
...
* restore feat→minor version bumps (remove bump-patch-for-minor-pre-major) ([3b2849a](https://github.com/pepe57/rag-kit/commit/3b2849aee32e4ba91d2815497ed3028d057c46ae))
* restore feat→minor version bumps (remove bump-patch-for-minor-pre-major) ([9326422](https://github.com/pepe57/rag-kit/commit/93264222ffe4263254644a80fe712fd051f1003e))
...
* **retrieval:** apply 0.4.1 API params to main's new AlbertRetrievalProvider class ([1439224](https://github.com/pepe57/rag-kit/commit/1439224868af495d4cfedd140609400291812801))
...
* set SECURITY INVOKER on ragas_export view ([b767e85](https://github.com/pepe57/rag-kit/commit/b767e85479f80e5407b6177724ea195b7a2e3ea7))
...
* show * feedback per character when entering API key ([c2fdf20](https://github.com/pepe57/rag-kit/commit/c2fdf20be908ae5a3e8e25fbf927e96cd86af438))
* show actionable warning when initial git commit fails ([ac72417](https://github.com/pepe57/rag-kit/commit/ac724178ad3d0caca4afc18a17007e61cd037e65))
...
* suppress uv output for just install, add dot spinner ([de5b611](https://github.com/pepe57/rag-kit/commit/de5b611727a5561c52a6ae795b038810d6060766))
* three bugs in dataset generation ([b82fb48](https://github.com/pepe57/rag-kit/commit/b82fb48e7154c839292334905bd1765ec714dc5e))
* translate init wizard question and choices to French ([208ef28](https://github.com/pepe57/rag-kit/commit/208ef28c953ea849316533f352cac2872017d135))
...
* use awk/ForEach-Object for safe API key substitution in .env ([79d82c9](https://github.com/pepe57/rag-kit/commit/79d82c9448712eb2ccc43a6a1b87a366b38fae27))
...
* use top-level project_id in supabase config.toml ([b3bffbd](https://github.com/pepe57/rag-kit/commit/b3bffbdb9f723b8d9228e5a0abde0b2f0e812b76))
...
* wire Albert semantic search + RRF fusion into memory_search tool ([fc5ca93](https://github.com/pepe57/rag-kit/commit/fc5ca93849ad5697bb102d3f91e0925e64147fe4))


### Documentation

* add Colima troubleshooting to Supabase setup guide ([17f7f1b](https://github.com/pepe57/rag-kit/commit/17f7f1b642319a7020b76b24b01a922dd97b4fb3))
...
* **albert-client:** add docstring examples and fix import order ([4f45fc7](https://github.com/pepe57/rag-kit/commit/4f45fc70065b27494e67c05fe6d1164335bee359))
...
* clarify SUPABASE_URL must be API URL, not REST URL ([8f56a3c](https://github.com/pepe57/rag-kit/commit/8f56a3c0c774f929dab9ee915e500335bc515ebf))
...
* remove PowerShell installer references, update Windows → Git Bash ([3608d6e](https://github.com/pepe57/rag-kit/commit/3608d6e2508c713f25773973c1b3aed8d31a33e7))
